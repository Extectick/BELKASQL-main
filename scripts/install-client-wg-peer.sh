...
sudo wg set "${WG_IFACE}" peer "${CLOUD_PEER_KEY}" allowed-ips 10.77.0.13/32 || true
...
sudo sed -i "/PublicKey = ${CLOUD_PEER_KEY//\//\\/}/{n;s#AllowedIPs = .*#AllowedIPs = 10.77.0.13/32#;}" "${WG_CONF}"
